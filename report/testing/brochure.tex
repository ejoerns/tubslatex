...
% \hNtoneleft[all][\tubspage@borderwidth]{8}{\paperwidth-\tubspage@borderwidth}%
% % {\textwidth}{tuWhite}{lborder}%
% {1\TPVertModule}{tuBlue}{bg1}%
% {2\TPVertModule}{tuBlue80}{bg2}%
% {3\TPVertModule}{tuBlue60}{bg3}%
% {4\TPVertModule}{tuBlue40}{bg4}%
% {5\TPVertModule}{tuBlue20}{bg5}%
% {6\TPVertModule}{tuGreen}{bg6}%
% {7\TPVertModule}{tuGreen80}{bg7}%
% {8\TPVertModule}{tuGreen60}{bg8}%


% sets background to 6 specified colors
\newcommand{\tubsSetBackground}[8]{%
\hNtoneleft[all][\tubspage@borderwidth]{8}{\paperwidth-\tubspage@borderwidth}%
% {\textwidth}{tuWhite}{lborder}%
{1\TPVertModule}{#8}{bg1}%
{2\TPVertModule}{#7}{bg2}%
{3\TPVertModule}{#6}{bg3}%
{4\TPVertModule}{#5}{bg4}%
{5\TPVertModule}{#4}{bg5}%
{6\TPVertModule}{#3}{bg6}%
{7\TPVertModule}{#2}{bg7}%
{8\TPVertModule}{#1}{bg8}%
}
