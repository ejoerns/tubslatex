\documentclass[%
  debug,
%   paper=42.0cm:59.4cm,%custompaper,% A2
  paperheight=59.4cm,paperwidth=42.0cm,custompaper,% A2
%   paperheight=42.0cm,paperwidth=59.0cm,%custompaper,% A2
%   a2paper,
%   paper=84.1cm:118.9cm,%custompaper,% A0
%   paperheight=118.9cm,paperwidth=84.1cm,%custompaper,% A0
%   a0paper,
%   landscape,
%   a2paper,
  style=scifi,table,%
...
\begin{document}
  \begin{tubsposter}[sender=bottom]{5cm,X,5.8cm,1.5cm}
