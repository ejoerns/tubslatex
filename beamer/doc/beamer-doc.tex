...
%% - Bemerkung über Option [fragile] für frame ? -> listing (alltt?)
%% - zusätzliche Schriftgrößen micro, nano
%% - Anmerkung zu Änderung von pdftitle? -> evtl. Option mit beachten?
%% - Anmerkung oder redefine:
%%     columns environmen nur mit [onlytextwidth] option sinnvoll
%% Changelog:
%% V 0.2.1:
%%  - 
%%  - 
...
\documentclass[cmyk,a4paper,colorscheme=green,TUBStitlepage=picture,
TUBSDesignHelper=true]{tubsreprt}
