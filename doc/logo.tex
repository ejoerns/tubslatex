...
vom Paket \Package{tubslogo} zur Verfügung gestellt.
...
\begin{minipage}{0.5\textwidth}
  ...
  \subcaption{Logo in Standardgröße (RGB, beamer)}
\end{minipage}
...
\begin{minipage}{0.5\textwidth}
  ...
  \subcaption{Logo in Standardgröße (HSK\,15)}
\end{minipage}
...
\begin{minipage}{0.5\textwidth}
  ...
  \subcaption{Logo in Standardgröße (schwarz, fett)}
\end{minipage}
...
Mit \Option{rgbbeamer} wird eine Beamer-optimierte RGB-Variante gewählt.
...
\begin{Declaration}
  \Option{custompaper}
\end{Declaration}
Die Option \Option{custompaper} ist für die Verwendung in Verbindung mit
...
Die Option \Option{scifiposter} aktiviert diese Anpassung.


\begin{Declaration}
  \KOption{relscale}\PName{Faktor}
\end{Declaration}
