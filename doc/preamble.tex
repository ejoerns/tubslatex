...
%   \end{description}
%    \begin{macrocode}
\DeclareRobustCommand*{\Macro}[1]{\index{cmd}{#1@\textbackslash#1}\mbox{\texttt{\char`\\#1}}}
...
\DeclareRobustCommand*{\Environment}[1]{\index{cmd}{#1}\mbox{\texttt{#1}}}
