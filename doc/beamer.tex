...
In der Fußbereich stehen standardmäßig Datum, Autor(en), (Kurz-)Titel und Seitenzahl.
Die Ausgabe kann jedoch durch eine Reihe von Beamer-Optionen angepasst werden.
...
Diese Optionen unterdrücken jeweils die Dsrstellung eienes Elementes in der Fußzeile.
\Option{nodate} sorgt dafür, dass das Datum nicht dargestellt wird,
\Option{noauthor} sorgt.. %TODO: hier weiter!
