...
\emph{links} bzw. \emph{innen} platziert. Dies entspricht der Standardeinstellung.
...
Mit der Option \Option{rechts} bzw. \Option{outside} wird das Logo auf der \emph{rechten}
...
\section{Kombination}\label{sec:gausspage:kombi}
