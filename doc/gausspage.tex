...
Zur Verwendung siehe auch Listing~\ref{lst:bglayout}.
...
Farbe gefüllt. Die verfügbaren Farben können Kapitel~\ref{sec:tubscolors}
entnommen werden.
...
\section{Kombination / Gaußraster-Seiten}\label{sec:gausslayout:gausspage}
...
Als \PName{Optionen} können alle in Kapitel~\ref{sec:gausslayout:bglayout}
...
Als \PName{Optionen} können alle in Kapitel~\ref{sec:gausslayout:bgsegment}
...
\begin{figure}\centering
  ...
  \begin{minipage}{0.35\textwidth}
    ...
    \subcaption{Absenderbereicht oben}\label{fig:gausslayout:topsender}
  \end{minipage}
  \quad
  \begin{minipage}{0.35\textwidth}
    \fbox{\includegraphics[width=\textwidth,page=2]{examples/gausssegments.pdf}}
    \subcaption{Absenderbereicht unten}\label{fig:gausslayout:bottomsender}
  \end{minipage}
