...
\begin{Declaration}
  \KOption{paper}\PName{Breite:Höhe}\\
...
% - landscape-Option nicht unterstützt? oder nicht genutzt?
% TODO: Hinweis, dass bis Koma 3.01 Höhe:Breite galt?
...
\begin{Declaration}
  \Macro{maketitle}\OParameter{style,Optionen}
\end{Declaration}
...
% TODO: Hinweis zu Schriftgrößen-Option?
...
Hier können die in Kapitel~\ref{sec:gausslayout:bgsegment} beschriebenen Werte
verwendet werden.
...
\Macro{showtubslogo} stellt das Siegelbandlogo dar, während
\Macro{showlogo} das Instituts-Logo und \Macro{showtopline}
einer rote Trennlinie anzeigt.
Für Details zur Verwendung und verfügbarer Optionen sei hier auf
\chaptername~\ref{sec:gausslayout:bglayout:elemente} verwiesen.
...
in Kapitel~\ref{sec:gausslayout:bgsegment} zu entnehmen.
...
erstellt werden, welche in Kapitel~\ref{sec:gausslayout:gausspage} näher beschrieben ist.
...
Mit dieser Option kann die Darstellung des Siegelbandlogos auf der
Titelseite komplett deaktiviert werden.


\begin{Declaration}
  \KOption{title}\PName{normal/small}
\end{Declaration}

Im Vergleich zu den Standardklassen ist die voreingestellte Schriftgröße
für die Überschrift recht groß. Um diese etwas kleiner darzustellen,
kann die Option \KOption{titel}\PValue{small} verwendet werden.
Diese verwendet statt der normalen Schrift (headline) die kleinere
Alternativ-Version (subheadline).
...
% \begin{center}
  ...
  \begin{minipage}[t]{0.6\textwidth}
    ...
    \par\bigskip
    \Macro{maketitle}\OParameter{plain}
    \par\bigskip
...
% TODO: place here?
\begin{Declaration}
  \Option{smallchapters}
\end{Declaration}
Die standardmäßig vorgesehen Schriftgröße für Überschriften der Ebene \Macro{chapter}
...
\Option{smallchapters} auf eine kleinere CD-konforme Variante der Überschriften
umschalten.
% TODO: allgemeine Erklärung der Verwendung von Klassenoptionen?
% - Gesamtauflistug der verfügbaren Optionen?s
% - Erklärung für tubsdoc, welche nutzbar, welche nichtß

\paragraph{Schriftauszeichnung}\label{par:documents:schriftauszeichnung}
\Index{Schriftauszeichnung|indexbf}
...
und weitere Möglichkeiten siehe Kapitel~\ref{sec:tubscolors}.%TODO...
...
\begin{hint}
  ...
  Dies kann mit der Option \Option{richblack} erreicht werden.
...
\begin{important}
  ...
  mit \Option{mono} oder eine Neudefinition von \texttt{tubsBlack} vorzuziehen.
\end{important}
