...
\textcolor{tuSecondary}{Dies ist ein Text in \texttt{tuSecondary}.}
\textcolor{tuViolet}{Dies ist ein Text in \texttt{tuViolet}.}
\textcolor{tuGreenDark}{Dies ist ein Text in \texttt{tuGreenDark}.}\bigskip
